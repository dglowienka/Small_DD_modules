...
layers 			= ['SiO2' , 'ITO' , 'NiOx'  ,  'MAPbI3_GQ' , 'PCBM' , 'BCP' , 'Au']
thicknesses		      = [0      , 125   ,  45    ,  375         , 40     , 5     , 100]
...
varyFinish		= 700	# final thickness of the layer to be varied (nm)
varyStep		= 10		# thickness increments (nm)
